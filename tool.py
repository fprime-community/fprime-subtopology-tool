                    ...
                    for member in topology.members():
                        ...
                        if "SpecConnectionGraph" in member[1]:
                            ...
                            for connection in connectionGraph.cg_connections:
                                print(f"[INFO] Connection: {connection['source']['name']}{connection['source']['num']} -> {connection['dest']['name']}{connection['dest']['num']}")
...
def FppWriteTest():
    ...
    component = FppWriter.FppInstance("TestComponent", {
    ...
    f.write(cg.connect({
        "source": {
            "name": "TestComponent.pout",
            "num": "0"
        },
        "dest": {
            "name": "TestComponent.pin",
            "num": "1"
        }
    }) + "\n")
