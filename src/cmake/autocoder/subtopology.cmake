...
function(subtopology_setup_autocode AC_INPUT_FILE)
    ...
    set(GENERATED_FILES "${CMAKE_CURRENT_BINARY_DIR}/${FPRIME_CURRENT_MODULE}.subtopolgies.fpp")

    if (CMAKE_DEBUG_OUTPUT)
        message(STATUS "[Subtopology Ac] CLI: ${PYTHON} ${PYTHON_TOOL} --locs ${CMAKE_BINARY_DIR}/locs.fpp --file ${AC_INPUT_FILE} --p ${GENERATED_FILES}")
    endif()

    execute_process(
        COMMAND ${PYTHON} ${PYTHON_TOOL} --locs ${CMAKE_BINARY_DIR}/locs.fpp --file ${AC_INPUT_FILE} --p ${GENERATED_FILES}
